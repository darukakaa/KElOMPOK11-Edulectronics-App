...
public class LatihanBab1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latihan_bab1);
        ...
        proses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                if(value_no1.getText().toString().toLowerCase().equals("a. Kumparan yang terbuat dari kabel panjang dan dililitkan")){
                    nilai = nilai + 20;
                }
                ...
                Intent i = new Intent(LatihanBab1.this, ResultBab1.class);
